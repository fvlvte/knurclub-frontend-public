...
const AudioController = ({onPlay, onEnded, onTimeUpdate, source, volume}: AudioControllerProps) => {
    ...
    return <audio src={source} onPlay={handlePlaybackStart} onEnded={handlePlaybackEnd} onTimeUpdate={handleTimeUpdate} ref={ref}/>
}
